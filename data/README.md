Landscape Capital Explorer Data Repository
==============================

This repository contains all the data processing required for the Landscape Capital Explorer project.
...
```shell
docker exec -it lce_data_notebooks /bin/bash
```
...
``` bash
mamba env create -n lce_data -f environment.yml
```

This will create an environment called LCE_data with a common set of dependencies.
